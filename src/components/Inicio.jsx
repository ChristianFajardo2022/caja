...
const Inicio = ({ videoId, isTablet, isMobile }) => {
  ...
  return (
    <div id="inicio" className="comercial">
      ...
      {playing && (
        <div ref={videoRef} className=" propaganda absolute max-xl:w-11/12 top-1/2 max-xl:left-1/2 max-xl:translate-x-[-50%] translate-y-[-50%]">
          <YouTube videoId={videoId} opts={!isMobile ? opts : optsMobil} />
        </div>
      )}
      ...
      <div className="w-full">
        ...
        <div className="flex-col justify-center text-center text-[#e2d599] bg-black xs:px-3.5">
          <h2 className="text-[#e2d599] xl:tracking-[7px] xs:tracking-[3px] m-0 px-4">
