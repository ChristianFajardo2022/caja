          ...
          <>
            ...
            {openImg !== 0 && (
              <div className="galeria opacity-0 w-1/2 translate-y-4 flexCenterC h-full ">
                <div ref={imagenRef} className="imagenEfecto Amentti">
                  ...
                  <h3 className="text-sm tracking-[7px] uppercase mt-8 mb-4 Amentti">
                  ...
                  <p className="text-start text-sm tracking-[7px] mb-4">
