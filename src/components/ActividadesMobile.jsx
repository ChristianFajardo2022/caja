...
const ActividadesMobile = () => {
  ...
  console.log(openImg);
  return (
    <div className={`z-10 w-full h-full relative mb-[290px]`}>
      {openImg !== 0 && (
      ...
      {openImg === 0 && (
        <div className="showAgendar galeria w-full h-full flex flex-col justify-start items-center ">
          ...
          <h2 className="colorTextoClaro xs:px-3.5">
            <span className="text-center flexCenterC xs:px-3.5">
            Estamos desde las 10 a.m. hasta las 10 p.m. en la plazoleta de la <br /> calle 85 con carrera 15 en
              Bogotá
            </span>
          </h2>
        </div>
